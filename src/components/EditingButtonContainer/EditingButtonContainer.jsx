...
const EditingButtonContainer = ({
  ...
  return (
    <s.ButtonsContainer className="editing-button">
      <EditingButton
        IconComponent={readList.length < 10 ? PinPost : PinPostRed}
        onClickButton={addPostToList}
      />
      <EditingButton
        IconComponent={EditPost}
        onClickButton={handleShowUpdatePopup}
      />
      <EditingButton
        IconComponent={DeletePost}
        onClickButton={handleShowDeletePopup}
      />
    </s.ButtonsContainer>
  );
};
